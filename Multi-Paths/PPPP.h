...
class MIXIM_API CnSmp1 : public BaseNetwLayer
{
private:
   CnSmp1(const CnSmp1&);
    CnSmp1& operator=(const CnSmp1&);
...
int posture;
    ...
    bool notBroadcasted( CnSmp1Pkt* );

    void forwardControl( CnSmp1Pkt* );

    void recuControl( CnSmp1Pkt* );

    void multiSend( CnSmp1Pkt* );

    /** @brief Decapsulate a message */
    cMessage* decapsMsg(CnSmp1Pkt *msg);
